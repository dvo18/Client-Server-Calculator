...
class CalculadoraHandler:
    def __init__(self):
        ...
        self.final_wrn = []
        self.warnings = [
            "---error: el tamaño de todas las filas de las matrices debe ser el mismo---",
            "---error: el tamaño del vector debe ser el mismo que el número de filas o columnas de la matriz---",
            "---error: el número de columnas de la primera matriz debe ser igual al número de filas de la segunda---",
            "---error: el formato de los parámetros no es correcto---",
            "---error: no se puede dividir por cero (contiene el cero)---",
            "---error: el tamaño de las matrices debe ser el mismo---",
            "---error: los vectores no tienen igual tamaño---",
            "---warning: se está calculando el producto escalar---",
            "---warning: matemáticamente el producto vectorial se realiza sobre vectores de dimension 3---",
            "---warning: el producto vectorial de dos vectores de tamaño 2 darán como resultado un entero---",
            "---warning: se está calculando el producto vectorial---",
            "---error: el producto vectorial se debe aplicar sobre vectores de tamaño igual o menor que 3---",
            "---error: el producto vectorial se debe aplicar sobre vectores de tamaño mayor a 1---",
            "---error: el valor debe estar entre -1 y 1---",
            "---error: la función trigonométrica no existe o no se ha implementado aún---",
            "---error: el formato del parámetro no es correcto---"
        ]
    ...
    def setWarnings(self,tipo):
        if tipo>=0 and tipo<=len(self.warnings): self.final_wrn.append(str(tipo)+self.warnings[tipo])
